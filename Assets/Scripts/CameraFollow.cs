...
public class CameraFollow : MonoBehaviour 
{
    ...
    public Vector2 minMaxZoom;      // use for dolly zoom on the player.
	...
	void FixedUpdate ()
	{
        ...
        zoomLevel = zoomLevel - mouseWheelDelta * zoomSensitivity;
        zoomLevel = Mathf.Clamp(zoomLevel, minMaxZoom.x, minMaxZoom.y);
